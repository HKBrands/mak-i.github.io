              ...
              <div class="col-sm-6">
                ...
                <form id="contactForm" role="form" method="post" action="php/contact.php">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" id="email" name="number" placeholder="Your Number*" required="required" data-validation-required-message="Please enter your number."/>
                    <p class="help-block text-danger"></p>
                  </div>
                  <div class="form-group">
