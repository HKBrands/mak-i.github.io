...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <div class="main">
        <section class="module bg-dark-60 shop-page-header" data-background="assets/images/shop/slider2.jpg">
          <div class="container">
            <div class="row">
	...
	$query_count="SELECT COUNT(id) AS id FROM `products`";
	$run_count= mysqli_query($con,$query_count);
	$fetch_count=mysqli_fetch_assoc($run_count);
	$total= $fetch_count['id'];
	$pages= $total / $limit;
	echo $pages;
?>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="pagination font-alt">
                    <a href="products.php?page=<?php $previous; ?>""><i class="fa fa-angle-left"></i></a>
                    ...
                    ?>
                    <a href="products.php?page=<?php $next; ?>""><i class="fa fa-angle-right"></i></a>
                </div>
              </div>
            </div>
          </div>
