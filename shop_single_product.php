<?php
 ...
 if(isset($_GET['ref'])){
           ...
           if($query_row >0){
               $productdata=mysqli_fetch_assoc($query_run);
           }else{
...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>Mak-i | Buy Prodocuts In Valuable Prices</title>
    <!--  
    Favicons
    =============================================
    -->
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="../">Mak.i</a>
          </div>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 mb-sm-40"><a class="gallery" href="<?php echo $productdata['image']?>"><img src="<?php echo $productdata['image']?>" alt="<?php echo $productdata['image']?>"/></a>
                <ul class="product-gallery">
                  <li><a class="gallery" href="<?php echo $productdata['image2']?>"><img src="<?php echo $productdata['image2']?>" alt="<?php echo $productdata['image2']?>"/></a></li>
                  <li><a class="gallery" href="<?php echo $productdata['image3']?>"><img src="<?php echo $productdata['image3']?>" alt="<?php echo $productdata['image3']?>"/></a></li>
                  <li><a class="gallery" href="<?php echo $productdata['image4']?>"><img src="<?php echo $productdata['image4']?>" alt="<?php echo $productdata['image4']?>"/></a></li>
                </ul>
              </div>
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-sm-12">
                    <h1 class="product-title font-alt"><?php echo $productdata['name']?></h1>
                  </div>
                </div>
                <!--<div class="row mb-20">-->
                ...
                <div class="row mb-20">
                  <div class="col-sm-12">
                    <div class="price font-alt">Rs.<span class="amount"><?php echo $productdata['price']?></span></div>
                  </div>
                </div>
                <form action="shop_single_product.php" method="post">
                    <div class="row mb-20">
                  <div class="col-sm-4 mb-sm-20"><label> Enter Full Name:</label></div>
                  <div class="col-sm-8">
                    <input class="form-control input-lg" type="name" name="username" required="required"/>
                  </div>
                </div>
                <div class="row mb-20">
                  <div class="col-sm-4 mb-sm-20"><label> Enter Contact Number:</label></div>
                  <div class="col-sm-8">
                    <input class="form-control input-lg" type="number" name="usernumber" min="1" required="required"/>
                  </div>
                </div>
                <div class="row mb-20">
                  <div class="col-sm-4 mb-sm-20"><label> Enter Shipping Address:</label></div>
                  <div class="col-sm-8">
                    <textarea class="form-control input-lg" type="text" name="useraddress" rows="10" columns="5" required="required"></textarea>
                  </div>
                </div>
                <div class="row mb-20">
                  <div class="col-sm-4 mb-sm-20"><label> Quantity:</label></div>
                  <div class="col-sm-8">
                    <input class="form-control input-lg" type="number" name="userquantity" value="1" max="40" min="1" required="required"/>
                  </div>
                </div>
                <div class="row mb-20">
                    <input type="hidden" name="productid" value="<?php echo $productdata['id']; ?>"/>
                    <div class="col-sm-8"><button class="btn btn-lg btn-block btn-round btn-b" name="orderplaced">Buy Now</button></div>
                </div>
                </form>
                <div class="row mb-20">
                  <div class="col-sm-12">
    ...
    <?php
        $random="SELECT * FROM `products` order by rand()";
        $random_run=mysqli_query($con,$random);
        if($random_run==true){
            ?>
            <div class="row">
              <div class="owl-carousel text-center" data-items="5" data-pagination="false" data-navigation="false">
            <?php
            while($random_fetch=mysqli_fetch_array($random_run)){
                ?>
                <div class="owl-item">
                  <div class="col-sm-12">
                    <div class="ex-product"><a href="https://mak-i.000webhostapp.com/shop_single_product.php?ref=<?php echo $random_fetch['id']; ?>&productbuy=true"><img style="height:140px; width:180px;" src="<?php echo $random_fetch['image']; ?>" alt="<?php echo $random_fetch['name']; ?>"/></a>
                      <h4 class="shop-item-title font-alt"><a href="https://mak-i.000webhostapp.com/shop_single_product.php?ref=<?php echo $random_fetch['id']; ?>&productbuy=true"><?php echo $random_fetch['name']; ?></a></h4><?php echo $random_fetch['price']; ?>
                    </div>
                  </div>
                </div>
                <?php
      ...
      <!--  <section class="module">
        ...
        <footer class="footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2020&nbsp;<a href="index.html">MAK.i</a>, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
                <div class="footer-social-links"><a href="https://www.facebook.com/MAKi.tshirts/"><i class="fa fa-facebook"></i></a>
                </div>
              </div>
            </div>
          </div>
...
<?php
       ...
       if(isset($_POST['orderplaced'])){
        ...
        $query="INSERT INTO `orders`(`username`, `usernumber`, `userquantity`, `useraddress`, `status`, `productid`) VALUES ('$username','$usernumber','$userquantity','$useraddress','$status','$productid')";
        $run=mysqli_query($con,$query);
        
        if($run==true){
            ?>
            <script>
                window.location = "shop_single_product.php?check=true&type=<?php echo $productid; ?>&r=success";
            </script>
            <?php
        }
    }else if(isset($_GET['type'])){
