  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
            ...
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;assets/images/shop/slider1.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-2">THIS IS MAK.i</div>
                  <div class="font-alt mb-30 titan-title-size-4">SUMMER 2020</div>
                  <div class="font-alt mb-40 titan-title-size-1">Your online store destination</div><a class="section-scroll btn btn-border-w btn-round" href="products.html">Show Products</a>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark shop-page-header" style="background-image:url(&quot;assets/images/shop/slider3.jpg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1"> THIS IS MAK.i</div>
                  <div class="font-alt mb-40 titan-title-size-4">Quality products</div><a class="section-scroll btn btn-border-w btn-round" href="products.php">View Products</a>
                </div>
              </div>
            </li>
          </ul>
	...
	while ($x < 8){
		...
		<div class="col-sm-6 col-md-3 col-lg-3">
            <div class="shop-item">
                <div class="shop-item-image"><img style="height:300px; width:770px;" src="<?php echo $result['image']?>" alt="<?php echo $result['name']?>" />
                    <div class="shop-item-detail">
                    		<a class="btn btn-round btn-b" href="shop_single_product.php?ref=<?php echo $result['id']?>&productbuy=true" name="buynow"><span class="icon-basket">Buy Now</span></a>
                    </div>
                </div>
                <h4 class="shop-item-title font-alt"><a href="#"><?php echo $result['name']?></a></h4><?php echo $result['price']?>
            </div>
        </div>
		<?php
		$x++;
